...
Public Class frmOrigenDocvsTipoAccion
    Inherits frmMantenimientos
    'Dim iClase As Integer = 101
    'Dim iClaseMov As Integer = 96
...
#Region "Funciones Sobrescritas"
    ...
    Protected Overrides Sub seleccionarListado()
        Try
            If lstTablaGeneral.SelectedItem IsNot Nothing Then
                ...
                lTablaGeneral = MantenimientosBL.Instancia.tablageneralListar_XClsId_XTgExtra(EEComun.ClasesTramiteSTD.tgOrigen_vs_tgAccion, loTablaGeneral.TgCodigo)
                ...
                If lTablaGeneral IsNot Nothing Then
                    For Each fTablaGeneral As EETablaGeneral In lTablaGeneral
                        dtTablaGeneral.LoadDataRow(New Object() { _
                               ...
                               EEComun.ClasesTramiteSTD.tgOrigen_vs_tgAccion, _
    ...
    Protected Overrides Sub listar()
        Try
            ...
            lstTablaGeneral.DataSource = MantenimientosBL.Instancia.tablageneralListarXClsIdListarCriterio(EEComun.ClasesTramiteSTD.tgOrigen, GCriterioBuscado, GValorTextoBuscado)
            MyBase.listar()
        Catch ex As Exception
            SaimtMessageBox.mostrarAlertaError(ex.Message)
        End Try
    ...
    Protected Overrides Sub Buscar()
        Try
            ...
            GCriterioBuscado = 1
            lstTablaGeneral.DataSource = MantenimientosBL.Instancia.tablageneralListarXClsIdListarCriterio(EEComun.ClasesTramiteSTD.tgOrigen, 1, txtBuscarPor.Text)
            MyBase.Buscar()
        Catch ex As Exception
            SaimtMessageBox.mostrarAlertaError(ex.Message)
        End Try
    ...
    Protected Overrides Sub guardar()
        Try
            ...
            For Each fTablaGeneral As DataRow In dtTablaGeneral.Rows
                ...
                loClase.ClsId = EEComun.ClasesTramiteSTD.tgOrigen_vs_tgAccion
                loClaseExtra.ClsId = EEComun.ClasesTramiteSTD.tgOrigen
...
#End Region
    ...
    Private Sub frmEstadosVsAcciones_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ...
        sCboAccion.Properties.DataSource = MantenimientosBL.Instancia.tablageneralListarXClsId(EEComun.ClasesTramiteSTD.tgAccion)
