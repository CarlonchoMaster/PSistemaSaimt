...
Public Class frmAccionesVsEstadoMovSTD
...
#Region "Funciones Sobrescritas"
    ...
    Protected Overrides Sub seleccionarListado()
        Try
            If lstTablaGeneral.SelectedItem IsNot Nothing Then
                ...
                lTablaGeneral = MantenimientosBL.Instancia.tablageneralListar_XClsId_XTgExtra(EEComun.ClasesTramiteSTD.tgAccion_vs_tgEstadoMov, loTablaGeneral.TgCodigo)
                ...
                If lTablaGeneral IsNot Nothing Then
                    For Each fTablaGeneral As EETablaGeneral In lTablaGeneral
                        dtTablaGeneral.LoadDataRow(New Object() { _
                              ...
                              EEComun.ClasesTramiteSTD.tgAccion_vs_tgEstadoMov, _
    ...
    Protected Overrides Sub listar()
        Try
            ...
            lstTablaGeneral.DataSource = MantenimientosBL.Instancia.tablageneralListarXClsIdListarCriterio(EEComun.ClasesTramiteSTD.tgAccion, GCriterioBuscado, GValorTextoBuscado)
            MyBase.listar()
        Catch ex As Exception
            SaimtMessageBox.mostrarAlertaError(ex.Message)
        End Try
    ...
    Protected Overrides Sub Buscar()
        Try
            ...
            GCriterioBuscado = 1
            lstTablaGeneral.DataSource = MantenimientosBL.Instancia.tablageneralListarXClsIdListarCriterio(EEComun.ClasesTramiteSTD.tgAccion, 1, txtBuscarPor.Text)
            MyBase.Buscar()
        Catch ex As Exception
            SaimtMessageBox.mostrarAlertaError(ex.Message)
        End Try
    ...
    Protected Overrides Sub guardar()
        Try
            ...
            For Each fTablaGeneral As DataRow In dtTablaGeneral.Rows
                ...
                loClase.ClsId = EEComun.ClasesTramiteSTD.tgAccion_vs_tgEstadoMov
                loClaseExtra.ClsId = EEComun.ClasesTramiteSTD.tgEstadoMov
...
#End Region
    ...
    Private Sub frmEstadosVsAcciones_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        sCboEstado.Properties.DataSource = MantenimientosBL.Instancia.tablageneralListarXClsId(EEComun.ClasesTramiteSTD.tgEstadoMov)
