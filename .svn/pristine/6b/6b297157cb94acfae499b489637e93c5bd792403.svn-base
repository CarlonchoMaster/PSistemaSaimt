...
Public Class frmConsultaInmuebleXAlta
...
#End Region
    ...
    Protected Overrides Sub buscar()
        Try
            Dim tgEstado As String = "02" ' Todos los Inmuebles no Registrados
            Dim ListaInmueble As List(Of EEInmueble) = Nothing
            If rdbCriterios.SelectedIndex = 0 Then
                ListaInmueble = MantenimientosBL.Instancia.inmuebleListarBCriterio(, , , , txtBuscar.Text, , , tgEstado)
            ElseIf rdbCriterios.SelectedIndex = 1 Then
                ListaInmueble = MantenimientosBL.Instancia.inmuebleListarBCriterio(, , txtBuscar.Text, , , , , tgEstado)
            ElseIf rdbCriterios.SelectedIndex = 2 Then
                ListaInmueble = MantenimientosBL.Instancia.inmuebleListarBCriterio(, , , , , txtBuscar.Text, , tgEstado)
            End If
            oTable.Clear()
