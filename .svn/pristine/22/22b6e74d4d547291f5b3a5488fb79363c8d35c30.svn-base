...
Public Class frmRptPivotOrdenesServicio
    Dim dtpivot As DataTable = New DataTable()
    Dim Registro(29) As Object
...
#Region "Construir Table"
    Private Sub ConstruirTableOrdenServicioDetalle()
        ...
        dtpivot.Columns.Add("TgCompPago", GetType(String))
        ...
        dtpivot.Columns.Add("OrdenServicioDet.OrdDetId", GetType(String))
        dtpivot.Columns.Add("OrdenServicioDet.ordDetRta4ta", GetType(Decimal))
        dtpivot.Columns.Add("OrdenServicioDet.ordDetAjuste", GetType(Decimal))
        dtpivot.Columns.Add("OrdenServicioDet.OrdDetDescripcion", GetType(String))
        dtpivot.Columns.Add("OrdenServicioDet.TgCatServ", GetType(String))
        dtpivot.Columns.Add("OrdenServicioDet.OrdDetPrecio", GetType(Decimal))
    End Sub
#End Region
    ...
    Private Sub btnmostrarxfecha_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnmostrarxfecha.Click
        ...
        Dim ListaOrdenServicioDetalle As List(Of EEOrdenServicio) = ReportesBL.Instancia.ReportePivotearOrdenServicioXFecha(dtpFechaInicio.EditValue, dtpFechaFin.EditValue)
