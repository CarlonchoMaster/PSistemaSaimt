...
#End Region
    ...
    Public Shared Function AbonadoPendienteXabonNPlaca(ByVal asAbonNPlaca As [String]) As EEAbonoPEM
        Dim loAbonoPEM As EEAbonoPEM = Nothing
        Dim dr As IDataReader = Nothing
        Try
            Dim db As Database = DatabaseFactory.CreateDatabase()
            Dim cmd As DbCommand = db.GetStoredProcCommand("Mostrar_AbonoPEMPendiente_XabonNPlaca_pa")
