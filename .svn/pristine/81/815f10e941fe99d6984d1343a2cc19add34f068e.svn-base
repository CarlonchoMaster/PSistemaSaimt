...
Public Class frmTransferencia
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        If DateEdit1.EditValue IsNot Nothing Then
            ...
            If ListaRecaudacion IsNot Nothing And ListaRecaudacionDet IsNot Nothing Then
                ...
                Next
            Else
                SaimtMessageBox.mostrarAlertaInformativa("No se pudo completar la Transferencia, Revise los detalles de la Recaudación")
                Return
            End If
