...
Public Class frmExtornarIngresoRinconada
...
#End Region
    ...
    Private Sub frmExtornarIngreso_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ConstruirTable()
        ...
        cboMotivoExtorno.Properties.DataSource = MantenimientosBL.Instancia.tablageneralListarXClsId(199)
    ...
    Private Sub mCargarDiario()
        Try
            Dim ListaDiarioPEM As List(Of EEDiarioPEM) = MantenimientosBL.Instancia.diarioRinconadaListarParaExtorno_XFecha(dtpfechabusqueda.EditValue)
            dtDiarioPEM.Clear()
        ...
        If Me.gvExtorno.DataRowCount <> 0 Then
            ...
            If SaimtMessageBox.mostrarAlertaPregunta("Desea Extornar") Then
                Try
                    ...
                    loAbonExtorno.DiarioCod = gvExtorno.GetRowCellValue(Me.gvExtorno.GetSelectedRows(0), "DiarioCod").ToString()
                    ...
                    MantenimientosBL.Instancia.diarioRinconadaExtornoGuardar(loAbonExtorno)
    ...
    Private Sub gvExtorno_RowStyle(ByVal sender As System.Object, ByVal e As DevExpress.XtraGrid.Views.Grid.RowStyleEventArgs) Handles gvExtorno.RowStyle
