...
Public Class frmEstadoSiguiente
    Inherits frmMantenimientos
    Dim iClaseEstadoSiguiente As Integer = 99
    ...
    Protected Overrides Sub seleccionarListado()
        Try
            If lstTablaGeneral.SelectedItem IsNot Nothing Then
                ...
                lTablaGeneral = MantenimientosBL.Instancia.tablageneralListar_XClsId_XTgExtra(iClaseEstadoSiguiente, loTablaGeneral.TgCodigo)
    ...
    Protected Overrides Sub guardar()
        Try
            ...
            For Each fTablaGeneral As DataRow In dtTablaGeneral.Rows
                ...
                loClase.ClsId = iClaseEstadoSiguiente
...
#End Region
    ...
    Private Sub btnAgregar_Click(sender As System.Object, e As System.EventArgs) Handles btnAgregar.Click
        If String.IsNullOrEmpty(txtNombre.Text) Then
            ...
            Exit Sub
        End If
        If String.IsNullOrEmpty(sCboEstadoSiguiente.EditValue) Then
            SaimtMessageBox.mostrarAlertaAdvertencia("Seleccione el siguiente estado")
            sCboEstadoSiguiente.Focus()
            Exit Sub
        End If
        ...
        For Each fTablaGeneral As DataRow In dtTablaGeneral.Rows
            If (fTablaGeneral("tgCodigo") = sCboEstadoSiguiente.EditValue) Then 'Or sCboEstadoSiguiente.Text = txtNombre.EditValue Then
                repite = True
            End If
        Next
        ...
        dtTablaGeneral.LoadDataRow(New Object() { _
            0, _
            iClaseEstadoSiguiente, _
            sCboEstadoSiguiente.Text, _
           sCboEstadoSiguiente.EditValue, _
            EstSelecCodigo, _
            chkEstado.Checked
        }, True)
        ...
        loTablaGeneral.TgNombre = sCboEstadoSiguiente.Text
        loTablaGeneral.TgExtra = EstSelecCodigo
        loTablaGeneral.TgCodigo = sCboEstadoSiguiente.EditValue
    ...
    Private Sub frmEstadoSiguiente_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        Me.PuedeBuscar = True
        Me.PuedeCrear = True
        Me.PuedeEditar = True
        ...
        sCboEstadoSiguiente.mColumnas(SaimtComboBoxLookUp.Entidades.TablaGeneral)
        sCboEstadoSiguiente.Properties.DisplayMember = "TgNombre"
        sCboEstadoSiguiente.Properties.ValueMember = "TgCodigo"
        sCboEstadoSiguiente.Properties.DataSource = MantenimientosBL.Instancia.tablageneralListarXClsId(iClaseEstadoSeleccionado)
        sCboEstadoSiguiente.ItemIndex = 0
