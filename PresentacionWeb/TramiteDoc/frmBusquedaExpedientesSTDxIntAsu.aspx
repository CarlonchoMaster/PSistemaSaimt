<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/PrincipalTra.Master" CodeBehind="frmBusquedaExpedientesSTDxIntAsu.aspx.vb" Inherits="PresentacionWeb.frmBusquedaExpedientesSTDxIntAsu" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <cc1:SaimtASPxRoundPanel ID="SaimtASPxRoundPanel1" runat="server" Width="990px"
        HeaderText="Expediente Ingresado por Interesado">
        ...
        <PanelCollection>
            <dx:PanelContent runat="server" SupportsDisabledAttribute="True">
                ...
                <td align="right" rowspan="2">
                    <cc1:SaimtASPxRadioButtonList ID="CExpInt_Eleccion" runat="server" 
                        CssFilePath="~/App_Themes/PlasticBlue/{0}/styles.css" CssPostfix="PlasticBlue" 
                        RightToLeft="False" SelectedIndex="0" 
                        SpriteCssFilePath="~/App_Themes/PlasticBlue/{0}/sprite.css" Width="173px" 
                        AutoPostBack="True" >
                        <Items>
                            <dx:ListEditItem Selected="True" Text="Asunto" Value="0" />
                            <dx:ListEditItem Text="Procedimiento" Value="1" />
                            <dx:ListEditItem Text="Interesado" Value="2" />
                        </Items>
                ...
                <td align="left" colspan="4">
                    ...
                    <cc1:SaimtASPxLabel ID="CExpInt_lblEleccion" runat="server" 
                        CssFilePath="~/App_Themes/PlasticBlue/{0}/styles.css" CssPostfix="PlasticBlue">
                    </cc1:SaimtASPxLabel>
                    <cc1:SaimtASPxComboBox ID="CExpInt_Procedimiento" runat="server" 
                        AutoPostBack="True"   
                        CssFilePath="~/App_Themes/PlasticBlue/{0}/styles.css" CssPostfix="PlasticBlue" 
                        SpriteCssFilePath="~/App_Themes/PlasticBlue/{0}/sprite.css" 
                        ValueType="System.String" Width="250px">
                    </cc1:SaimtASPxComboBox>
                    <cc1:SaimtASPxTextBox ID="CExpInt_AsuOrInt" runat="server" 
                        CssFilePath="~/App_Themes/PlasticBlue/{0}/styles.css" CssPostfix="PlasticBlue" 
                        SpriteCssFilePath="~/App_Themes/PlasticBlue/{0}/sprite.css" Text="" Width="99%">
                ...
                <td style="margin-left: 40px">
                    ...
                    <tr>
                        <td align="left">
                            <cc1:SaimtASPxLabel ID="CExpInt_lblFechaInicio" runat="server" 
                                CssFilePath="~/App_Themes/PlasticBlue/{0}/styles.css" CssPostfix="PlasticBlue" 
                                Text="Fecha de Inicio">
                            </cc1:SaimtASPxLabel>
                        </td>
                        <td align="left">
                            <cc1:SaimtASPxDateEdit ID="CExpInt_FechaInicio" runat="server" 
                                CssFilePath="~/App_Themes/PlasticBlue/{0}/styles.css" CssPostfix="PlasticBlue" 
                                SpriteCssFilePath="~/App_Themes/PlasticBlue/{0}/sprite.css" Width="100px">
                            </cc1:SaimtASPxDateEdit>
                        </td>
                        <td align="left">
                            <cc1:SaimtASPxLabel ID="CExpInt_lblFechaFin" runat="server" 
                                CssFilePath="~/App_Themes/PlasticBlue/{0}/styles.css" CssPostfix="PlasticBlue" 
                                Text="Fecha de Final ">
                            </cc1:SaimtASPxLabel>
                        </td>
                        <td style="margin-left: 40px">
                            <cc1:SaimtASPxDateEdit ID="CExpInt_FechaFin" runat="server" 
                                CssFilePath="~/App_Themes/PlasticBlue/{0}/styles.css" CssPostfix="PlasticBlue" 
                                SpriteCssFilePath="~/App_Themes/PlasticBlue/{0}/sprite.css" Width="100px">
                            </cc1:SaimtASPxDateEdit>
                        </td>
     ...
     <tr>
                ...
                <tr>
                <td colspan="2" >
                    <cc1:SaimtASPxGridView ID="CExpInt_dgvResultado" runat="server" 
...
<dx:GridViewDataTextColumn FieldName="dias" ShowInCustomizationForm="True" Caption="Resuelto<br/>(Dias)" 
                ...
                <td align="center" colspan="2">
                    <cc1:SaimtASPxLabel ID="CExpInt_lblResultado" runat="server" 
                        CssFilePath="~/App_Themes/PlasticBlue/{0}/styles.css" 
