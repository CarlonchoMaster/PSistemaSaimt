<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="frmBusquedaXCodMargesi.aspx.vb" Inherits="PresentacionWeb.frmBusquedaXCodMargesi" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <cc1:SaimtASPxRoundPanel ID="SaimtASPxRoundPanel1" runat="server" 
        ...
        HeaderText="BÚSQUEDA POR CÓDIGO MARGESÍ MPT: Consigna el número de file y rubro" 
        Width="990px">
