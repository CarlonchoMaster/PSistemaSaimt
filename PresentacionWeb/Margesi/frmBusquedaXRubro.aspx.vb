...
Public Class frmBusquedaXRubro
    ...
    Private Sub cboProvincia_Callback(sender As Object, e As DevExpress.Web.CallbackEventArgsBase) Handles cboProvincia.Callback
    ...
    Protected Sub cboDistrito_Callback(sender As Object, e As DevExpress.Web.CallbackEventArgsBase) Handles cboDistrito.Callback
        cargarDistrito(Session("clavecboDepartamento"), cboProvincia.Value)
    End Sub

    
    Protected Sub txtsubdistritoscbo_Callback(sender As Object, e As DevExpress.Web.CallbackEventArgsBase) Handles txtsubdistritoscbo.Callback
