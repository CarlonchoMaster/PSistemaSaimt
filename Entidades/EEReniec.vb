...
#Region "Propiedades"
    ...
    ''' </summary>
    Public ReadOnly Property GetCapcha() As System.Drawing.Image
        Get
            Return ReadCapcha()
        End Get
    End Property
...
#End Region
    ...
    ''' </summary>
    Private Function ReadCapcha() As System.Drawing.Image
        Try
            Dim myUrl As String = "http://cel.reniec.gob.pe/valreg/codigo.do"
            ...
            Return System.Drawing.Image.FromStream(myImgStream)
        Catch ex As Exception
            Throw ex
        End Try
    End Function
