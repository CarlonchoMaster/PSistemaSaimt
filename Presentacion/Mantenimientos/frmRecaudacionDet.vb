...
Public Class frmRecaudacionDet
    ...
    Public Sub New(ByVal RecId As String, ByVal RecfecPag As Date, ByVal RecaudadorId As String, ByVal RecMonto As Decimal, ByVal Depositante As String, ByVal tipoDoc As String, ByVal NDoc As String, ByVal concepto As String, ByVal FecLiquidacion As Date, ByVal grupo As String)
        ' Llamada necesaria para el diseñador.
        InitializeComponent()
        ' Agregue cualquier inicialización después de la llamada a InitializeComponent().
        lsRecId = RecId
    ...
    Private Sub frmRecaudacionDet_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        cboConcepto.Properties.DataSource = MantenimientosBL.Instancia.conceptoListarXAñoXTgGrupo(dtpRecfecPago.DateTime.Year, lsGrupoId)
    ...
    Private Sub btnexportar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnexportar.Click
        ...
        If sfdexportar.ShowDialog = Windows.Forms.DialogResult.OK Then
            Me.dgvRecaudacionDet.ExportToXls(sfdexportar.FileName)
        End If
    End Sub
End Class