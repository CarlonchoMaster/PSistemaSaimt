...
Public Class frmBoleteriaRinconada
    ...
    Private Sub btnOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOK.Click
        ...
        Dim bolCod As String = MantenimientosBL.Instancia.boleteriaRinconadaGenerarBolCodigo
        Dim loBoleteria As New EEBoleteriaRinconada() With {.bolCod = bolCod, .bolcantidad = SaimtSpinner1.Value, .TgEstadoId = "01", .ConId = cboConcepto.EditValue, .bolFechaIng = Date.Now, .bolHoraIng = Date.Now, .bolPrecio = conImporte, .bolId = 0, .PerRegId = EEComun._PerId}
        txtNticket.Text = bolCod
        If String.Compare(bolCod, "", True) <> 0 And MantenimientosBL.Instancia.boleteriaRinconadaGuardar(loBoleteria) = True Then
    ...
    Private Sub btnExtornar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnExtornar.Click
        If gvBoleteria.DataRowCount <> 0 Then
            MantenimientosBL.Instancia.boleteriaRinconadaExtornoXBolCod(gvBoleteria.GetRowCellValue(Me.gvBoleteria.GetSelectedRows(0), "bolCod").ToString())
