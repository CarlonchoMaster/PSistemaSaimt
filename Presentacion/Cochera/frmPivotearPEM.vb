...
#End Region
    ...
    Private Sub frmPivotearPEM_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ConstruirTable()
    ...
    Private Sub btnMostrarXFecha_Click(sender As System.Object, e As System.EventArgs) Handles btnMostrarXFecha.Click
        Try
            ...
            If rdgFechas.SelectedIndex = 0 Then
                ListaReporte = ReportesBL.Instancia.reportePivotearPEM(0, dtpDiario.EditValue.ToString())
            ElseIf rdgFechas.SelectedIndex = 1 Then
                ListaReporte = ReportesBL.Instancia.reportePivotearPEM(1, dtpInicioIntervalo.EditValue.ToString() & "-" & dtpFinIntervalo.EditValue.ToString())
            ElseIf rdgFechas.SelectedIndex = 2 Then
                ListaReporte = ReportesBL.Instancia.reportePivotearPEM(2, cboMensual.EditValue.ToString())
            End If
            dtPivot.Rows.Clear()
